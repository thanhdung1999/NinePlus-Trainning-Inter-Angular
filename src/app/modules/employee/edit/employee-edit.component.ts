...
<<<<<<<< HEAD:src/app/modules/employee/employee-edit/employee-edit.component.ts
import { NotificationService } from 'src/app/shared/services/notification.service';
const MESSAGE_WARNING = {
    REQUIRED_VALIDATION: 'Kiểm tra lại thông tin các trường bắt buộc nhập (*)',
};
========
>>>>>>>> 66cb026 ([SBFA-1] update translate for booking):src/app/modules/employee/edit/employee-edit.component.ts
@Component({
