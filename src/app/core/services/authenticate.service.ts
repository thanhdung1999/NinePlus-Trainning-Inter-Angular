...
export class AuthenticateService extends ApiBaseService {
    ...
    sendMailForGot(body: any): Observable<any> {
        return this.httpClient.post(
            this.apiBasePath + '/api/account/forgot-password',
            body
        );
    }
    ...
    resestPasword(body: any): Observable<any> {
        return this.httpClient.post(
            this.apiBasePath + '/api/account/reset-password',
            body
        );
    }

    logOut(): void {
        this._sessionService.userAuthenticate &&
    ...
    changePassword(body: any): Observable<any> {
        return this.httpClient.post(
            this.apiBasePath + '/api/account/change-password',
            body
        );
    }
}
